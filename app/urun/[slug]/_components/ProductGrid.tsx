  ...
  return (
    <>
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {items.map((p) => (
          <div key={p.slug} className="group relative rounded-3xl border border-zinc-200 bg-white p-4 shadow-sm transition hover:shadow-md">
            {/* Card link area */}
      ...
      {open && active ? (
        ...
        >
          ...
          {/* ESC ile kapatma için basit hack: butona odak */}
          <button
            className="sr-only"
            autoFocus
            onKeyDown={(e) => {
