      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <section className="rounded-3xl border border-zinc-200 bg-white p-5 shadow-sm">
          ...
          <div className="mt-4 grid gap-3">
            <input className="h-11 rounded-2xl border border-zinc-200 px-4 text-sm outline-none focus:border-zinc-300"
              placeholder="Ad Soyad" />
            <input className="h-11 rounded-2xl border border-zinc-200 px-4 text-sm outline-none focus:border-zinc-300"
              placeholder="Telefon" />
            <input className="h-11 rounded-2xl border border-zinc-200 px-4 text-sm outline-none focus:border-zinc-300"
              placeholder="E-posta" />
            <textarea className="min-h-[96px] rounded-2xl border border-zinc-200 px-4 py-3 text-sm outline-none focus:border-zinc-300"
              placeholder="Adres" />
